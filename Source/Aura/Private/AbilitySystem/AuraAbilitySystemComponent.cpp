...
{
	OnGameplayEffectAppliedDelegateToSelf.AddUObject(this, &UAuraAbilitySystemComponent::Client_AffectApplied);
}
...
void UAuraAbilitySystemComponent::Client_AffectApplied_Implementation(UAbilitySystemComponent* AbilitySystemComponent,
